...
Restore Fails When There Are No Backups
    [Documentation]    Restoring will fails when the storage contains no backups at all.
...
Restore Fails When There Are No Suitable Backups
    ...
    FOR    ${counter}    IN RANGE    1    4
        ...
        Sleep    2s
    END
    Command Should Fail    microshift restore --save-failed=false --auto-recovery ${WORKDIR}
...
Restore Selects Right Backup
    ...
    Command Should Work    microshift restore --save-failed=false --auto-recovery ${WORKDIR}
