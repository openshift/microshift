...
${SERVER_POD}           assets/services/hello-microshift.yaml
${SERVER_INGRESS}       assets/services/hello-microshift-ingress.yaml
${SERVER_SVC}           assets/services/hello-microshift-service.yaml
${TEST_NS}              ${EMPTY}
