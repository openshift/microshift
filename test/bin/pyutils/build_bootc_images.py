...
def set_rpm_version_info_vars():
    ...
    global BREW_PREV_ZSTREAM_VERSION
    ...
    BREW_PREV_ZSTREAM_VERSION = common.get_env_var('BREW_PREV_ZSTREAM_VERSION', '')
...
def main():
    ...
    try:
        ...
        if args.no_extract_images:
            ...
            if BREW_PREV_ZSTREAM_VERSION:
                extract_container_images(BREW_PREV_ZSTREAM_VERSION, BREW_REPO, CONTAINER_LIST, args.dry_run)
