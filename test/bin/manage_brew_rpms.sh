...
usage() {
    ...
    echo "  download:   Download RPM packages to the specified path"
    echo "    - version: the X.Y version. Example: 4.22"
    ...
    echo "      For 'zstream': downloads latest and previous z-stream of the given minor,"
    echo "                     plus latest z-stream of Y-1 and Y-2 minors"
    echo "      For 'rc', 'ec', 'nightly': downloads the latest build of that type"
