...
MICROSHIFT_Z1_X86_64_RPMS_LIST=(
    "${MICROSHIFT_Y2_X86_64_RPMS_LIST[@]}"
)
...
export MICROSHIFT_Z1_OPTIONAL_RPMS="${MICROSHIFT_Z1_OPTIONAL_RPMS_LIST[*]}"
...
export MICROSHIFT_Z1_X86_64_RPMS="${MICROSHIFT_Z1_X86_64_RPMS_LIST[*]}"
