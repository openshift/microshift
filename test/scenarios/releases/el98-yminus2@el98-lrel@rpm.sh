...
scenario_run_tests() {
    ...
    configure_rhocp_repo "${RHOCP_MINOR_Y2}"      "${YMINUS2_MAJOR_VERSION}" "${YMINUS2_MINOR_VERSION}"
    configure_microshift_mirror "${YMINUS2_RELEASE_REPO}"
    ...
    run_tests host1 \
        ...
        --variable "PREVIOUS_MINOR_VERSION:${YMINUS2_MINOR_VERSION}" \
