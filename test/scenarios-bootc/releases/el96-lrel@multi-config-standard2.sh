...
EOF"
    ...
    # Run all tests except configuration.robot (which expects no drop-in configs)
    # The configuration test conflicts with our TLS drop-in file at /etc/microshift/config.d/10-tls.yaml
