...
scenario_create_vms() {
    ...
    LVM_SYSROOT_SIZE=20480 prepare_kickstart host1 kickstart-bootc-offline.ks.template rhel96-bootc-source-optionals
    launch_vm --boot_blueprint rhel96-bootc-source-optionals --no_network --vm_disksize 30
}
