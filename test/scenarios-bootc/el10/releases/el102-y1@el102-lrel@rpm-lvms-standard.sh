...
scenario_run_tests() {
    ...
    # Install the previous version, upgrade to the current version,
    # then run LVMS validation and standard test suites.
    run_tests host1 \
        --exitonfailure \
    ...
    # Post-upgrade: Create LVMS workloads and validate LVMS is working
    echo "INFO: Creating LVMS workloads after upgrade..."
    ...
    # Run standard1 and standard2 suites for basic validation
    run_tests host1 \
