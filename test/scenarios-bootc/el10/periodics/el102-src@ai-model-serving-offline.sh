...
scenario_create_vms() {
    ...
    LVM_SYSROOT_SIZE=20480 prepare_kickstart host1 kickstart-bootc-offline.ks.template rhel102-bootc-source-ai-model-serving
    launch_vm rhel102-bootc-source-ai-model-serving --no_network --vm_disksize 30
}
