...
scenario_create_vms() {
    prepare_kickstart host1 kickstart-bootc.ks.template rhel102-bootc-source-ipsec
    prepare_kickstart host2 kickstart-bootc.ks.template rhel102-bootc-source-ipsec
    prepare_kickstart host3 kickstart-bootc.ks.template rhel102-bootc-source-ipsec
