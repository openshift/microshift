...
2. Save report to `/tmp/analyze-ci-claude-workdir/create-bugs-analyze-ci-<release>-<timestamp>.txt`
3. Display summary to user:

**Dry-run report format**:
```text
===============================================================
CREATE BUGS FOR ANALYZE-CI - DRY-RUN REPORT
Release: <release>
Date: YYYY-MM-DD
===============================================================
...
Report saved: /tmp/analyze-ci-claude-workdir/create-bugs-analyze-ci-<release>-<timestamp>.txt
===============================================================
```
...
```text
===============================================================
CREATE BUGS FOR ANALYZE-CI - CREATION REPORT
Release: <release>
Date: YYYY-MM-DD
===============================================================
