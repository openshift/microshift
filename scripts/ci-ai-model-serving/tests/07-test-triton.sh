...
MODEL_IMAGE="quay.io/pmatusza/ai-testing-model:onnx-triton"
...
# ServingRuntime definition from https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/2.21/html-single/serving_models/index#adding-a-tested-and-verified-model-serving-runtime-for-the-single-model-serving-platform_serving-large-models
