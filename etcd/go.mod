...
require (
	...
	k8s.io/apiserver v1.31.13 // indirect
)
...
require (
	...
	k8s.io/api v1.31.13 // indirect
	k8s.io/client-go v1.31.13 // indirect
...
replace (
	...
	go.etcd.io/etcd/pkg/v3 => github.com/openshift/etcd/pkg/v3 v3.5.1-0.20250801133949-b5a4f8d079fb // from etcd
	go.etcd.io/etcd/raft/v3 => github.com/openshift/etcd/raft/v3 v3.5.1-0.20250801133949-b5a4f8d079fb // from etcd
	go.etcd.io/etcd/server/v3 => github.com/openshift/etcd/server/v3 v3.5.1-0.20250801133949-b5a4f8d079fb // from etcd
)
