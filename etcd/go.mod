...
require (
	...
	k8s.io/apiserver v1.33.13 // indirect
	k8s.io/kubelet v1.33.13 // indirect
...
require (
	...
	k8s.io/api v1.33.13 // indirect
	k8s.io/client-go v1.33.13 // indirect
...
replace (
	...
	go.etcd.io/etcd/pkg/v3 => github.com/openshift/etcd/pkg/v3 v3.5.1-0.20260206170206-05bca97760b1 // from etcd
	go.etcd.io/etcd/raft/v3 => github.com/openshift/etcd/raft/v3 v3.5.1-0.20260206170206-05bca97760b1 // from etcd
	go.etcd.io/etcd/server/v3 => github.com/openshift/etcd/server/v3 v3.5.1-0.20260206170206-05bca97760b1 // from etcd
)
