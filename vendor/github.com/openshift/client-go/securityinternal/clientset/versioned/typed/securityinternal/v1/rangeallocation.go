...
func (c *rangeAllocations) Apply(ctx context.Context, rangeAllocation *securityinternalv1.RangeAllocationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RangeAllocation, err error) {
