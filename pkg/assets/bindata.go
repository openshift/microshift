...
func assetsComponentsOpenshiftDnsNodeResolverDaemonsetYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/components/openshift-dns/node-resolver/daemonset.yaml.tmpl", size: 2023, mode: os.FileMode(436), modTime: time.Unix(1654679854, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsComponentsOpenshiftDnsNodeResolverUpdateNodeResolverSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/components/openshift-dns/node-resolver/update-node-resolver.sh", size: 2285, mode: os.FileMode(436), modTime: time.Unix(1654679854, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsComponentsOvnMasterDaemonsetYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/components/ovn/master/daemonset.yaml", size: 19966, mode: os.FileMode(436), modTime: time.Unix(1654679854, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
