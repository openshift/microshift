...
var _assetsCrdRouteCrdYaml = []byte(`apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
...
func assetsCrdRouteCrdYamlBytes() ([]byte, error) {
	return _assetsCrdRouteCrdYaml, nil
}

func assetsCrdRouteCrdYaml() (*asset, error) {
	bytes, err := assetsCrdRouteCrdYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "assets/crd/route.crd.yaml", size: 18418, mode: os.FileMode(420), modTime: time.Unix(1664090284, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"assets/crd/route.crd.yaml":                                                                              assetsCrdRouteCrdYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"assets": {nil, map[string]*bintree{
		...
		"crd": {nil, map[string]*bintree{
			...
			"route.crd.yaml":                   {assetsCrdRouteCrdYaml, map[string]*bintree{}},
