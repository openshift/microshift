...
func assetsComponentsOvnConfigmapYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/components/ovn/configmap.yaml", size: 847, mode: os.FileMode(420), modTime: time.Unix(1664948113, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsComponentsOvnMasterDaemonsetYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/components/ovn/master/daemonset.yaml", size: 16276, mode: os.FileMode(420), modTime: time.Unix(1664948113, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
