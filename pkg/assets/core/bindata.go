...
var _assetsCore0000_10_namespaceSecurityAllocationController_saYaml = []byte(`apiVersion: v1
kind: ServiceAccount
metadata:
...
func assetsCore0000_10_namespaceSecurityAllocationController_saYamlBytes() ([]byte, error) {
	return _assetsCore0000_10_namespaceSecurityAllocationController_saYaml, nil
}

func assetsCore0000_10_namespaceSecurityAllocationController_saYaml() (*asset, error) {
	bytes, err := assetsCore0000_10_namespaceSecurityAllocationController_saYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "assets/core/0000_10_namespace-security-allocation-controller_sa.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"assets": {nil, map[string]*bintree{
		"core": {nil, map[string]*bintree{
			...
			"0000_10_namespace-security-allocation-controller_sa.yaml":                 {assetsCore0000_10_namespaceSecurityAllocationController_saYaml, map[string]*bintree{}},
