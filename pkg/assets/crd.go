...
var (
	...
	crds                = []string{
		...
		"components/csi-snapshot-controller/volumegroupsnapshotclasses.yaml",
		"components/csi-snapshot-controller/volumegroupsnapshotcontents.yaml",
		"components/csi-snapshot-controller/volumegroupsnapshots.yaml",
