...
// Experimental!
func ExtractRangeAllocationStatus(rangeAllocation *securityinternalv1.RangeAllocation, fieldManager string) (*RangeAllocationApplyConfiguration, error) {
	return extractRangeAllocation(rangeAllocation, fieldManager, "status")
}

func extractRangeAllocation(rangeAllocation *securityinternalv1.RangeAllocation, fieldManager string, subresource string) (*RangeAllocationApplyConfiguration, error) {
	b := &RangeAllocationApplyConfiguration{}
