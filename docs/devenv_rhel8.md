...
- Select Installation Destination
  - Under _Storage Configuration_ sub-section, select "Custom" radial button.
  ...
  - Select the root partition (`/`).  On the right side of the menu, set "Desired Capacity" to 30.
  - Click "Done" button.
