...
require (
	...
	k8s.io/api v1.33.5
	k8s.io/apiextensions-apiserver v1.33.5
	k8s.io/apimachinery v1.33.5
	k8s.io/apiserver v1.33.5
	k8s.io/cli-runtime v1.33.5
	k8s.io/client-go v1.33.5
	k8s.io/cloud-provider v1.33.5
	k8s.io/component-base v1.33.5
	k8s.io/kube-aggregator v1.33.5
	k8s.io/kubectl v1.33.5
	k8s.io/kubelet v1.33.5
...
require (
	...
	k8s.io/cluster-bootstrap v1.33.5 // indirect
