...
require (
	...
	k8s.io/kubelet v1.32.6 // indirect
...
replace (
	...
	sigs.k8s.io/kube-storage-version-migrator => github.com/openshift/kubernetes-kube-storage-version-migrator v0.0.3-0.20250606130804-4ab93e07bb7c // release kube-storage-version-migrator via kubernetes-kube-storage-version-migrator
)
