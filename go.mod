...
require (
	...
	github.com/openshift/route-controller-manager v0.0.0-20260223153627-ec18e9be0ebc
	...
	k8s.io/api v1.33.12
	k8s.io/apiextensions-apiserver v1.33.12
	k8s.io/apimachinery v1.33.12
	k8s.io/apiserver v1.33.12
	k8s.io/cli-runtime v1.33.12
	k8s.io/client-go v1.33.12
	k8s.io/cloud-provider v1.33.12
	k8s.io/component-base v1.33.12
	k8s.io/kube-aggregator v1.33.12
	k8s.io/kubectl v1.33.12
	k8s.io/kubelet v1.33.12
...
require (
	...
	k8s.io/cluster-bootstrap v1.33.12 // indirect
	k8s.io/component-helpers v1.33.12 // indirect
	k8s.io/controller-manager v1.33.12 // indirect
	k8s.io/cri-api v1.33.12 // indirect
	k8s.io/cri-client v1.33.12 // indirect
	k8s.io/csi-translation-lib v1.33.12 // indirect
	k8s.io/dynamic-resource-allocation v1.33.12 // indirect
	k8s.io/endpointslice v1.33.12 // indirect
	k8s.io/externaljwt v1.33.12 // indirect
	k8s.io/kms v1.33.12 // indirect
	k8s.io/kube-controller-manager v1.33.12 // indirect
	k8s.io/kube-scheduler v1.33.12 // indirect
	k8s.io/metrics v1.33.12 // indirect
	k8s.io/mount-utils v1.33.12 // indirect
	k8s.io/pod-security-admission v1.33.12 // indirect
...
replace (
	go.etcd.io/etcd/api/v3 => github.com/openshift/etcd/api/v3 v3.5.1-0.20260206170206-05bca97760b1 // from etcd
	go.etcd.io/etcd/client/pkg/v3 => github.com/openshift/etcd/client/pkg/v3 v3.5.1-0.20260206170206-05bca97760b1 // from etcd
	go.etcd.io/etcd/client/v3 => github.com/openshift/etcd/client/v3 v3.5.1-0.20260206170206-05bca97760b1 // from etcd
)
