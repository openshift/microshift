...
require (
	...
	github.com/openshift/cluster-policy-controller v0.0.0-20260622225645-050c1ee6aeb0
	github.com/openshift/route-controller-manager v0.0.0-20260625182940-01ccbfb991fd
...
replace (
	...
	k8s.io/cri-streaming => ./deps/github.com/openshift/kubernetes/staging/src/k8s.io/cri-streaming // deps kubernetes-version
	k8s.io/streaming => ./deps/github.com/openshift/kubernetes/staging/src/k8s.io/streaming // deps kubernetes-version
)
