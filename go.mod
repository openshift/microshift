...
require (
	...
	github.com/openshift/api v0.0.0-20260713195309-f9b2d1ae30eb
	github.com/openshift/build-machinery-go v0.0.0-20250602125535-1b6d00b8c37c
	github.com/openshift/client-go v0.0.0-20241001162912-da6d55e4611f
	github.com/openshift/cluster-policy-controller v0.0.0-20260714082208-3b44245d8fe9
	github.com/openshift/library-go v0.0.0-20241107160307-0064ad7bd060
	github.com/openshift/route-controller-manager v0.0.0-20260601152317-2484b3e8e7fb
	...
	k8s.io/api v1.31.14
	k8s.io/cli-runtime v1.31.14
	k8s.io/klog/v2 v2.130.1
	k8s.io/kube-openapi v0.0.0-20240228011516-70dd3763d340
	k8s.io/kubectl v1.31.14
...
require (
	...
	k8s.io/apiextensions-apiserver v1.31.14
	k8s.io/apimachinery v1.31.14
	k8s.io/apiserver v1.31.14
	k8s.io/client-go v1.31.14
	k8s.io/cloud-provider v1.31.14
	k8s.io/component-base v1.31.14
	k8s.io/kube-aggregator v1.31.14
...
require (
	...
	k8s.io/cluster-bootstrap v1.31.14 // indirect
	k8s.io/component-helpers v1.31.14 // indirect
	k8s.io/controller-manager v1.31.14 // indirect
	k8s.io/cri-api v1.31.14 // indirect
	k8s.io/cri-client v1.31.14 // indirect
	k8s.io/csi-translation-lib v1.31.14 // indirect
	k8s.io/dynamic-resource-allocation v1.31.14 // indirect
	k8s.io/endpointslice v1.31.14 // indirect
	k8s.io/gengo/v2 v2.0.0-20240228010128-51d4e06bde70 // indirect
	k8s.io/kms v1.31.14 // indirect
	k8s.io/kube-controller-manager v1.31.14 // indirect
	k8s.io/kube-scheduler v1.31.14 // indirect
	k8s.io/kubelet v1.31.14 // indirect
	k8s.io/metrics v1.31.14 // indirect
	k8s.io/mount-utils v1.31.14 // indirect
	k8s.io/pod-security-admission v1.31.14 // indirect
...
replace (
	go.etcd.io/etcd/api/v3 => github.com/openshift/etcd/api/v3 v3.5.1-0.20250801133949-b5a4f8d079fb // from etcd
	go.etcd.io/etcd/client/pkg/v3 => github.com/openshift/etcd/client/pkg/v3 v3.5.1-0.20250801133949-b5a4f8d079fb // from etcd
	go.etcd.io/etcd/client/v3 => github.com/openshift/etcd/client/v3 v3.5.1-0.20250801133949-b5a4f8d079fb // from etcd
)
