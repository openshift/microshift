...
replace (
	...
	github.com/docker/distribution => github.com/openshift/docker-distribution v0.0.0-20180925154709-d4c35485a70d // changed by openshift-apiserver
	...
	github.com/docker/libnetwork => github.com/docker/libnetwork v0.0.0-20210525090646-64b7a4574d14 // microshift hack to work around Sirupsen/sirupsen issue
	...
	github.com/moby/buildkit => github.com/dmcgowan/buildkit v0.0.0-20170731200553-da2b9dc7dab9 // added by openshift-apiserver
	...
	github.com/openshift/cluster-ingress-operator => github.com/openshift/cluster-ingress-operator v0.0.0-20220316082543-e59a3a2e2d78
	...
	k8s.io/kubernetes => github.com/openshift/kubernetes v1.24.0-alpha.0.0.20220427003547-b463d71c3d5c // points to openshift/kubernetes release-4.10
...
require (
	...
	github.com/openshift/api v0.0.0-20220414050251-a83e6f8f1d50 // release-4.10
	github.com/openshift/build-machinery-go v0.0.0-20220121085309-f94edc2d6874 // release-4.10
	github.com/openshift/client-go v0.0.0-20211209144617-7385dd6338e3 // release-4.10
	github.com/openshift/oauth-apiserver v0.0.0-20220203215117-e85441345214 // release-4.10
	github.com/openshift/openshift-apiserver v0.0.0-alpha.0.0.20220214215439-6b16f7fa1a95 // release-4.10
	github.com/openshift/openshift-controller-manager v0.0.0-alpha.0.0.20220106174623-2c2d50dbda3a // release-4.10
