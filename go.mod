...
require (
	...
	k8s.io/api v1.31.12
	k8s.io/cli-runtime v1.31.12
	k8s.io/klog/v2 v2.130.1
	k8s.io/kube-openapi v0.0.0-20240228011516-70dd3763d340
	k8s.io/kubectl v1.31.12
...
require (
	...
	k8s.io/apiextensions-apiserver v1.31.12
	k8s.io/apimachinery v1.31.12
	k8s.io/apiserver v1.31.12
	k8s.io/client-go v1.31.12
	k8s.io/cloud-provider v1.31.12
	k8s.io/component-base v1.31.12
	k8s.io/kube-aggregator v1.31.12
...
require (
	...
	k8s.io/cluster-bootstrap v1.31.12 // indirect
	k8s.io/component-helpers v1.31.12 // indirect
	k8s.io/controller-manager v1.31.12 // indirect
	k8s.io/cri-api v1.31.12 // indirect
	k8s.io/cri-client v1.31.12 // indirect
	k8s.io/csi-translation-lib v1.31.12 // indirect
	k8s.io/dynamic-resource-allocation v1.31.12 // indirect
	k8s.io/endpointslice v1.31.12 // indirect
	k8s.io/gengo/v2 v2.0.0-20240228010128-51d4e06bde70 // indirect
	k8s.io/kms v1.31.12 // indirect
	k8s.io/kube-controller-manager v1.31.12 // indirect
	k8s.io/kube-scheduler v1.31.12 // indirect
	k8s.io/kubelet v1.31.12 // indirect
	k8s.io/metrics v1.31.12 // indirect
	k8s.io/mount-utils v1.31.12 // indirect
	k8s.io/pod-security-admission v1.31.12 // indirect
