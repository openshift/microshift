...
echo "Functions related to checking workloads health in /usr/share/microshift/functions/greenboot.sh"
echo "are now deprecated and will be removed in future release."
echo "Planned removal: MicroShift 4.22"
echo ""
echo "As a replacement consider using 'microshift healthcheck' command"
echo ""
echo "Deprecated functions:"
echo " - wait_for"
echo " - namespace_images_downloaded"
echo " - namespace_deployment_ready"
echo " - namespace_daemonset_ready"
echo " - namespace_pods_ready"
echo " - namespace_pods_not_restarting"
echo " - print_failure_logs"
echo " - log_failure_cmd"
echo " - log_script_exit"
echo " - lvmsDriverShouldExist"
echo " - csiComponentShouldBeDeployed"
echo ""
echo "--------------------"
echo ""
