...
%package opentelemetry-collector-config
Summary: OpenTelemetry Configuration for MicroShift
BuildArch: noarch
Requires: microshift = %{version}
...
install -p -m644 packaging/observability/microshift-opentelemetry-collector.service %{buildroot}%{_unitdir}/
...
%post opentelemetry-collector-config
%systemd_post microshift-opentelemetry-collector.service
...
%files opentelemetry-collector-config
%config %{_sysconfdir}/microshift/opentelemetry-collector.yaml
%config %{_unitdir}/microshift-opentelemetry-collector.service
