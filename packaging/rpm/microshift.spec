...
install -p -m755 packaging/greenboot/red.sh %{buildroot}%{_sysconfdir}/greenboot/red.d/40_microshift_persist_health.sh

install -d -m755 %{buildroot}%{_sysconfdir}/greenboot/green.d
install -p -m755 packaging/greenboot/green.sh %{buildroot}%{_sysconfdir}/greenboot/green.d/40_microshift_persist_health.sh
...
%{_sysconfdir}/greenboot/red.d/40_microshift_persist_health.sh
%{_sysconfdir}/greenboot/green.d/40_microshift_persist_health.sh
